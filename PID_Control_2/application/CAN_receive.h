...
extern int8_t  UART_TX_DATA[10];// serialplot发送数据数组
extern float output;
...
typedef struct
{
    ...
    int16_t given_current;//电机输入电流
    uint8_t temperate;//电机温度
    int16_t last_ecd;//上一次电机编码器值
} motor_measure_t;//电机数据结构体
